...
- (id)init {
    if (self = [super init]) {
        ...
        [self.selectBtn setImage:GetImage(@"wphoto_select_no") forState:UIControlStateNormal];
        [self.selectBtn setImage:GetImage(@"wphoto_select_yes") forState:UIControlStateSelected];
